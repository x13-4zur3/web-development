    ...
    const createParticles = () => {
      ...
      for (let i = 0; i < particleCount; i++) {
        particles.push({
          ...
          color: `rgba(125, 211, 252, ${Math.random() * 0.5 + 0.1})`, // Light blue color with varying opacity
        })
      }
    }
    ...
    const connectParticles = () => {
      for (let i = 0; i < particles.length; i++) {
        for (let j = i; j < particles.length; j++) {
          ...
          if (distance < 120) {
            ctx.beginPath()
            ctx.strokeStyle = `rgba(125, 211, 252, ${0.1 * (1 - distance / 120)})`
            ctx.lineWidth = 0.5
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-muted-foreground text-lg mb-8">
              Passionate about programming, game development, web technologies, and cybersecurity. Turning ideas into
